...
function initPolySphere2(gl) {
    ...
    const program = buildShaderProgram(gl, vertexSource2, fragmentSource2),
    ...
    gl.vertexAttribPointer(pointLocation, 3, gl.FLOAT, false, 3 * 4, 0);
